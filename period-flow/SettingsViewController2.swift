...
class SettingsViewController2: UIViewController {
    ...
    func setupContainers() {
        addTapGestureTo(cycleDurationView, selector: #selector(SettingsViewController2.displayDurationPicker))
        addTapGestureTo(notificationsView, selector: #selector(SettingsViewController2.displayNotificationPicker))
        addTapGestureTo(analysisBasisView, selector: #selector(SettingsViewController2.displayAnalysisPicker))
        addTapGestureTo(purchasesView, selector: #selector(SettingsViewController2.purchaseProPackPressed))
    }
